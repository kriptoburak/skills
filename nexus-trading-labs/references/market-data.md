...
| `deposit_requires_wallet_execution` | allowedRecipients blocking tx | Use a dedicated temporary key (no allowedRecipients), revoke after — don't clear it on the main key |
